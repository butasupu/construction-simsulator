Shader "WbShader/Ground/Terrain (SpecNorm)" {
Properties {
 ...
 _NormTex2 ("Splat Tex Norm 02", 2D) = "white" {}
 _MainTex3 ("Splat Tex 03 (G)", 2D) = "white" {}
 _NormTex3 ("Splat Tex Norm 03", 2D) = "white" {}
 _MainTex4 ("Splat Tex 04 (B)", 2D) = "white" {}
 _NormTex4 ("Splat Tex Norm 04", 2D) = "white" {}
 _scale ("UV Scale", Float) = 1
 _scaleSplat1 ("Splat1 Scale", Float) = 1
 _scaleSplat2 ("Splat2 Scale", Float) = 1
 _scaleSplat3 ("Splat3 Scale", Float) = 1
 _scaleSplat4 ("Splat4 Scale", Float) = 1
